...
declare namespace Cloudflare {
  interface Env {
    ...
    BASE_URL:
      | 'https://tanstack-start-cloudflare-worker-template.tomoya0209.workers.dev'
      | 'http://localhost:3000'
      | 'http://localhost:4173'
      | 'https://tanstack-start-cloudflare-worker-template-develop.tomoya0209.workers.dev'
      | 'https://tanstack-start-cloudflare-worker-template-staging.tomoya0209.workers.dev'
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ENVIRONMENT' | 'BASE_URL' | 'CLIENT_SECRET' | 'CLIENT_ID' | 'SESSION_SECRET'>
  > {}
}
