          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                <li>App名: tanstack-start-cloudflare-worker-template-develop</li>
            ...
            <div>
              ...
              <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                <li>App名: tanstack-start-cloudflare-worker-template-staging</li>
            ...
            <div>
              ...
              <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                <li>App名: tanstack-start-cloudflare-worker-template</li>
...
const isProd = import.meta.env.PROD`}</code>
  ...
  "env": {
    "develop": {
      "name": "tanstack-start-cloudflare-worker-template-develop",
      "vars": {
        "ENVIRONMENT": "develop",
